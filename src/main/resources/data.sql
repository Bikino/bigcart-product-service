...
insert into product_vendor(product_id, vendor_id, image_url, price, quantity, request_date, status) values (1, 1, '1.jpg', 600, 5, '2020-10-31', 'pending')
...
insert into product_vendor(product_id, vendor_id, image_url, price, quantity, request_date, status) values (2, 1, '2.jpg', 1150, 30, '2020-10-31', 'pending')
...
insert into product_vendor(product_id, vendor_id, image_url, price, quantity, request_date, status) values (3, 2, '3.jpg', 70, 100, '2020-10-31', 'pending')
