...
-- insert into product(description, name, specifications, category_id) values ('Nike sport shoes with comfortable design laptop', 'Nike sport shoes', 'ergonomic, elastic', 8)
-- insert into vendor_product(product_id, vendor_id, image_url, price, quantity, request_date, status, rating, rating_count) values (3, 2, '3.jpg', 70, 100, '2020-10-31', 'approved', 0, 0)

--
-- insert into product_image (id) values(4)
-- insert into product(description, name, specifications, category_id) values ('Stylish headphone best noise canceling you can get', 'Jabra Headphone', 'Bluetooth 5, 40 hrs play time, ', 7)
-- insert into vendor_product(product_id, vendor_id, image_url, price, quantity, request_date, status, rating, rating_count) values (4, 1, '4.jpg', 70, 100, '2020-10-31', 'pending', 0, 0)
--
--
...
-- insert into vendor_product(product_id, vendor_id, image_url, price, quantity, request_date, status, rating, rating_count) values (5, 1, '8.jpg', 70, 100, '2020-10-31', 'approved', 0, 0)
--
--
...
-- insert into vendor_product(product_id, vendor_id, image_url, price, quantity, request_date, status, rating, rating_count) values (6, 3, '5.jpg', 70, 100, '2020-10-31', 'pending', 0, 0)
--
--
...
-- insert into vendor_product(product_id, vendor_id, image_url, price, quantity, request_date, status, rating, rating_count) values (7, 3, '6.jpg', 70, 100, '2020-10-31', 'pending', 0, 0)
--
--
-- insert into product_image (id) values(10)
-- insert into product(description, name, specifications, category_id) values ('est road bike you can get', 'road bike X600', 'ergonomic, elastic', 8)
-- insert into vendor_product(product_id, vendor_id, image_url, price, quantity, request_date, status, rating, rating_count) values (8, 2, '10.jpg', 70, 100, '2020-10-31', 'pending', 0, 0)
--
--
--
...
-- insert into vendor_product(product_id, vendor_id, image_url, price, quantity, request_date, status, rating, rating_count) values (9, 1, '7.jpg', 70, 100, '2020-10-31', 'approved', 0, 0)
--
--
-- insert into product_image (id) values(9)
-- insert into product(description, name, specifications, category_id) values ('Nike sport watch with comfortable design ', 'Nike sport watch', 'ergonomic, elastic', 10)
-- insert into vendor_product(product_id, vendor_id, image_url, price, quantity, request_date, status, rating, rating_count) values (10, 1, '9.jpg', 70, 100, '2020-10-31', 'approved', 0, 0)
--
--
--
--
